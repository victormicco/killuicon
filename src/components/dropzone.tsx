          ...
          >
            ...
            {action.is_error ? (
              ...
              <div className="text-gray-400 text-md flex items-center gap-4">
                ...
                >
                  <Select.Trigger
                    className="w-32 outline-none focus:outline-none focus:ring-0 text-center text-gray-600 bg-gray-50 text-md font-medium"
                    placeholder="Trigger"
                  />
                      ...
                      <div className="grid grid-cols-2 gap-2 w-fit">
                        {extensions.image.map((elt, i) => (
                          <div key={i} className="col-span-1 text-center">
                            <Select.Item value={elt} className="mx-auto">
                              {elt}
                            </Select.Item>
                          </div>
                        ))}
